...
class="ml-2 mr-1" alt="German Flag"} Germany.  Also I love to travel the 🌍...
...
Also full time developer for a Association for Technical Inspection :icon{name="ic:twotone-car-repair"  alt="Car Repair Icon"}.
...
![Me in a buggy at Gran Canaria](/jan-petry.webp){class="rounded-lg h-60 w-60 mx-auto" format="webp" lazy="false"}
...
[:icon{name="tabler:input-ai" class="mx-1" alt="Purple Heart icon"} CloudSpike](https://cloudspike.app/){title="Open CloudSpike.app"}
